...
def get_text_messages(bot, cur_user, message):
    ...
    elif ms_text == "Все новости":
        get_all_news(bot, chat_id)

    elif ms_text == "Последние 5 новостей":
        get_last_five_news(bot, chat_id)

    elif ms_text == "Свежие новости":
        get_fresh_news(bot, chat_id)
